...
public class Chamado implements Serializable {
	...
	public Chamado(Integer id, LocalDate dataFechamento, Prioridade prioridade, Status status, String titulo,
			String observacaoes, Tecnico tecnico, Cliente cliente) {
		super();
		this.id = id;
